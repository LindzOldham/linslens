...
X='darkandlightprep_ctd' # with everything - lens on, big image, ovrs=2!!!
print X
...
img1 = py.open('/data/ljo31/Lens/J1144/F606W_sci_cutout_huge.fits')[0].data.copy()[40:-40,40:-40]
sig1 = py.open('/data/ljo31/Lens/J1144/F606W_noisemap_huge.fits')[0].data.copy()[40:-40,40:-40]
psf1 = py.open('/data/ljo31/Lens/J1144/F606W_psf1.fits')[0].data.copy()
psf1 = psf1/np.sum(psf1)
img2 = py.open('/data/ljo31/Lens/J1144/F814W_sci_cutout_huge.fits')[0].data.copy()[40:-40,40:-40]
sig2 = py.open('/data/ljo31/Lens/J1144/F814W_noisemap_huge.fits')[0].data.copy()[40:-40,40:-40]
...
result = np.load('/data/ljo31/Lens/LensModels/twoband/J1144_212')#LensModels/J1144_212_allparams')
result = np.load('/data/ljo31/Lens/J1144/twoband_darkandlightprep')#LensModels/J1144_212_allparams')
...
yc,yo=yc-90,yo-90
xc,xo=xc-95,xo-95
xc,xo,yc,yo=xc+40.,xo+40.,yc+40.,yo+40.
mask = py.open('/data/ljo31/Lens/J1144/mask_huge.fits')[0].data[40:-40,40:-40]
...
S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=22,nwalkers=50,ntemps=3)
S.sample(500)
...
for i in range(len(imgs)):
    ...
    for ii in range(len(components)):
        pl.figure()
        pl.imshow(components[ii],interpolation='nearest')
        pl.colorbar()
