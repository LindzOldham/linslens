...
def MakeTab(model,kmodel,name):
    ...
    ax1 = pl.subplot(131)#add_axes([0.02,0.1,0.23,0.87])
    ax2 = pl.subplot(132)#add_axes([0.27,0.1,0.23,0.87])
    ax3 = pl.subplot(133)#add_axes([0.52,0.1,0.23,0.87])
    ###
    ###
    ...
    ax1.imshow(vki,interpolation='nearest',origin='lower')  
    pl.figtext(0.09,0.18,"$1''$",color='White',fontsize=45,weight=1000,family='sans-serif',stretch='ultra-expanded')  
    # colour model
    ...
    pl.figtext(0.05,0.84,'data',fontsize=30,color='white',weight=1000,stretch='ultra-expanded',family='sans-serif')
    pl.figtext(0.37,0.84,'model',fontsize=30,color='white',weight=1000,stretch='ultra-expanded',family='sans-serif')
    pl.figtext(0.7,0.84,'S/N residuals',fontsize=30,color='k',weight=1000,stretch='ultra-expanded',family='sans-serif',backgroundcolor='white')
