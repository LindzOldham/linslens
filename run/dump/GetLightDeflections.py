...
def Deflect(model,kmodel,name,mass):
    ...
    if model.galno == 1.:
        ...
        lens1.b = lens1.getbFromMass(mass,sig_crit)
        print 'b', lens1.b
        lenses = [lens1]
    else:
        ...
        lens1.b = lens1.getbFromMass(mass+np.log10(f1),sig_crit*f1)
        lens2.b = lens2.getbFromMass(mass+np.log10(f2),sig_crit*f2)
