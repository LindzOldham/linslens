...
pl.suptitle(name)
pl.savefig('/data/ljo31/public_html/Lens/dark_and_light/compare_profiles_new/deprojected_%s.pdf'%name)
pl.show()
...
pl.savefig('/data/ljo31/public_html/Lens/dark_and_light/compare_profiles_new/stellarmass_%s.pdf'%name)
pl.show()
...
pl.ylabel('probability density')
pl.savefig('/data/ljo31/public_html/Lens/dark_and_light/compare_profiles_new/slope_%s.pdf'%name)
pl.show()
