...
# dust lane 
sx,sy = dic['Source 2 x'][a1,0,a3], dic['Source 2 y'][a1,0,a3]
SX2 = pymc.Uniform('Source 2 x',sx-5,sx+5,sx)
SY2 = pymc.Uniform('Source 2 y',sy-5,sy+5,sy)
SR2 = pymc.Uniform('Source 2 re',0.5,100,dic['Source 2 re'][a1,0,a3])
SN2 = pymc.Uniform('Source 2 n',0.5,8,dic['Source 2 n'][a1,0,a3])
SPA2 = pymc.Uniform('Source 2 pa',-90,90,dic['Source 2 pa'][a1,0,a3])
SQ2 = pymc.Uniform('Source 2 q',0.2,1.,dic['Source 2 q'][a1,0,a3])
