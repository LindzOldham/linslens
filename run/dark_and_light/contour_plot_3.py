...
outFile = '/data/ljo31b/EELs/aperture_mass_measure_inference_'+name
result = np.load(outFile)
lp,trace,dic,_ = result
ml, gamma = dic['ML'][:,0].ravel()/10., dic['gamma'][:,0].ravel()
...
xbins = np.linspace(0,2.5,20)
ybins = np.linspace(0,3,20)
smooth=1.  # experiment
