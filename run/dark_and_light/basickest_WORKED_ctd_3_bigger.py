...
sig1 = py.open('/data/ljo31/Lens/J0837/F606W_noisemap_huge.fits')[0].data.copy()[my-60:my+60,mx-60:mx+60]
psf1 = py.open('/data/ljo31/Lens/J0837/F606W_psf1.fits')[0].data.copy()
psf1 = psf1/np.sum(psf1)

mask = py.open('/data/ljo31/Lens/J0837/mask22.fits')[0].data.copy()[my-60:my+60,mx-60:mx+60]
mask = mask==1

sig1 = py.open('/data/ljo31b/EELs/galsub/images/'+name+'_maxlnL_sig.fits')[1].data[my-60:my+60,mx-60:mx+60]
#mask = py.open('/data/ljo31b/EELs/galsub/masks/'+name+'.fits')[0].data.copy()[my-45:my+45,mx-45:mx+45#]
#mask = mask==1
sig1 = Image.J0837()[1]
sig1 = sig1[my-60:my+60,mx-60:mx+60]
DX,DY = -100.,-100.
...
result = np.load('/data/ljo31/Lens/J0837/basickest_NEWIMS_BIGIMS_3_6temps_200walkers_150pixels')
...
import time
def doFit(p=None,doReg=True,updateReg=False,checkImgs=True,levMar=False):
    global reg
...
print 'reg',reg
'''
S = myEmcee.PTEmcee(pars+[likelihood],cov=cov,nthreads=40,nwalkers=200,ntemps=6)
S.sample(500)

print 'done emcee'
outFile = '/data/ljo31/Lens/J0837/basickest_NEWIMS_BIGIMS_3_6temps_200walkers_150pixels'
