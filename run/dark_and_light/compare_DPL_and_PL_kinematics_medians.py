...
Mstar_DPL = np.median(dic_DPL['stellar mass'])*100

print 'stellar masses:', Mstar_PL, Mstar_DPL
...
#sigma_TPL = rho_0**0.5 * sigma_dm_PL.eval(np.array([eta]))
...
print '###'
print (sigma_dm_PL.eval(np.array([eta_PL])))**0.5
print (rein_PL**(2.-eta_PL))**0.5
