...
oresult = np.load('/data/ljo31/Lens/LensModels/twoband/'+name+'_211')
result = np.load('/data/ljo31/Lens/J0901/basic_parametric_0')
...
dxs = [0.,odic['xoffset'][oa1,0,oa3]]
dys = [0.,odic['yoffset'][oa1,0,oa3]]
...
B = pymc.Uniform('Lens 1 b',0.0,100.,value=dic['Lens 1 b'][a1,0,a3])
...
Mstar = pymc.Uniform('stellar mass',0.0,10.,dic['stellar mass'][a1,0,a3])
pars += [Mstar]
cov += [0.5]
