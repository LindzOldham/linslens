...
def MakeModel(name,result,oldResult=None):
    ...
    outFile = '/data/ljo31b/EELs/galsub/emceeruns/'+name+'_parametric_DPL_darwin_1_newmask_ctd_ctd'
    ## new mask, old deflections
...
#oldResult = np.load('/data/ljo31b/EELs/galsub/emceeruns/'+name+'_parametric_DPL_5')
oldResult = np.load('/data/ljo31b/EELs/galsub/emceeruns/darwin/J0837_parametric_DPL_darwin_1_newmask_ctd')
