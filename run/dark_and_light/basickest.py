...
img1,img2 = img1[my-35:my+35,mx-35:mx+35], img2[my-35:my+35,mx-35:mx+35]
mask = py.open('/data/ljo31b/EELs/galsub/masks/'+name+'.fits')[0].data.copy()[my-35:my+35,mx-35:mx+35]
mask = mask==1
_,sig1,psf1,_,sig2,psf2,DX,DY,OVRS,_ = Image.J0837()  
sig1,sig2 = sig1[my-35:my+35,mx-35:mx+35], sig2[my-35:my+35,mx-35:mx+35]
y,x = iT.coords(img1.shape)
x,y = x+DX+(mx-35.), y+DY+(my-35.) 
...
S = myEmcee.PTEmcee(pars+[likelihood],cov=cov,nthreads=20,nwalkers=100,ntemps=3)
S.sample(500)

print 'done emcee'
outFile = '/data/ljo31/Lens/J0837/basickest_NEWIMS_BIGIMS'
