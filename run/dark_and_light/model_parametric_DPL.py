...
def MakeModel(name,result,oldResult=None):
    ...
    RS = pymc.Uniform('Lens 1 rs',0.05,650.,value=300) # 100 kpc 
    ...
    cov = [0.5,0.5,5.,0.1,0.5,1500.,5.,0.05,5.]
    ...
    print 'done emcee'
    outFile = '/data/ljo31b/EELs/galsub/emceeruns/'+name+'_parametric_DPL_5'
