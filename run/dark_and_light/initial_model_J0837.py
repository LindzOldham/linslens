...
points = np.array([[10.,20.],[10.,18.],[33.,23.],[10.,23.]])
points = np.array([[10.,20.],[33.,23.]])
...
LB = pymc.Uniform('Lens b',0.,b_start,b_start/2.) # assuming half is light, half dark for now
...
Mstar = pymc.Uniform('stellar mass',0.01,10.,Mstar_start)
