...
def plot(name):    
    ...
    pl.ylabel('stellar mass \n relative to a MW-like IMF',fontsize=30)
    ...
    pl.savefig('/data/ljo31/public_html/Lens/dark_and_light/compare_profiles_new/contour_plot_all_noJ0913.pdf')
