...
def MakeTab(file,name):
    ...
    np.save('/data/ljo31/Lens/PDFs/211_lensgal_huge_new_'+str(model.name), [np.array([model.muPDF]),np.array([model.magPDF]),np.array([ model.fitPDF]), model.viPDF,np.array([model.RePDF])])
    return med,lo,hi

dir = '/data/ljo31/Lens/LensModels/twoband/'
files = [dir+'J0837_211',dir+'J0901_211',dir+'J0913_211',dir+'J1125_211',dir+'J1144_211',dir+'J1218_211',dir+'J1323_211','/data/ljo31/Lens/J1347/twoband_0',dir+'J1446_211',dir+'J1605_211',dir+'J1606_211',dir+'J1619_211',dir+'J2228_211']
...
tbhdu.writeto('/data/ljo31/Lens/LensParams/Phot_1src_lensgals_huge_new.fits',clobber=True)

print 'FINISHED 1-SRC MODELS'
'''
dir = '/data/ljo31/Lens/LensModels/twoband/'
files = [dir+'J0837_211',dir+'J0901_211',dir+'J0913_212',dir+'J1125_212',dir+'J1144_212',dir+'J1218_211',dir+'J1323_211','/data/ljo31/Lens/J1347/twoband_212_2',dir+'J1446_212',dir+'J1605_212',dir+'J1606_212',dir+'J1619_212',dir+'J2228_212']
...
coldefs = ColDefs([c1,c2,c3,c4,c5,c6,c7,c8,c2l,c3l,c4l,c5l,c6l,c7l,c8l,c2h,c3h,c4h,c5h,c6h,c7h,c8h])
tbhdu = BinTableHDU.from_columns(coldefs)
tbhdu.writeto('/data/ljo31/Lens/LensParams/Phot_2src_lensgals_huge_new.fits',clobber=True)

print 'FINISHED 2-SRC MODELS'
