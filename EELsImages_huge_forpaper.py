...
def J0837_K():
    image = py.open('/data/ljo31/Lens/J0837/J0837_Kp_narrow_med.fits')[0].data.copy()[710:1200,690:1205]
    Dx,Dy = 16.,23.
    OVRS,pix=1,0.2
    Dx -=100.*pix
    Dy -=100.*pix
...
def J0901_K():
    image = py.open('/data/ljo31/Lens/J0901/J0901_Kp_narrow.fits')[0].data.copy()[400:820,410:860] # update this maybe?
    Dx,Dy = 9.,9.
    OVRS,pix=1,0.2
    Dx -=100.*pix
    Dy -=100.*pix
...
def J0913_K(srcno):
    image = py.open('/data/ljo31/Lens/J0913/J0913_nirc2_n_Kp_6x6.fits')[0].data.copy()[41:575,55:560]
    if srcno == 1:
        Dx,Dy = 5.,5.
    elif srcno ==2:
        Dx,Dy = -10.,-15.
...
def J1125_K():
    image = py.open('/data/ljo31/Lens/J1125/Kp_J1125_nirc2_n.fits')[0].data.copy()[550:1005,540:1015]
    Dx,Dy = 10.,12.
    OVRS,pix=1,0.2
    Dx -=100.*pix
    Dy -=100.*pix
...
def J1218_K():
    image = py.open('/data/ljo31/Lens/J1218/J1218_med.fits')[0].data.copy()[540:920,360:740]
    Dx,Dy = 10,0
    OVRS,pix = 1,0.6
    Dx -=100.*pix
    Dy -=100.*pix
...
def J1323_K():
    image = py.open('/data/ljo31/Lens/J1323/J1323_nirc2.fits')[0].data.copy()[515:935,755:1190]
    Dx,Dy = 20.,22.
    OVRS,pix=1,0.2
    Dx -=100.*pix
    Dy -=100.*pix
...
def J1347_K():
    image = py.open('/data/ljo31/Lens/J1347/J1347_med.fits')[0].data.copy()[800:1130,810:1125]
    Dx,Dy = -6.,-5.
    OVRS,pix = 4,0.6
    Dx -=100.*pix
    Dy -=100.*pix
...
def J1446_K():
    image = py.open('/data/ljo31/Lens/J1446/EEL1446_med.fits')[0].data.copy()[630:995,530:1020]
    Dx,Dy = 21.,14.
    OVRS,pix=1,0.2
    Dx -=100.*pix
    Dy -=100.*pix
...
def J1605_K():
    image = py.open('/data/ljo31/Lens/J1605/J1605_Kp_narrow_med.fits')[0].data.copy()[435:840,490:935]
    Dx,Dy = 4.,5.
    OVRS,pix=1,0.2
    Dx -=100.*pix
    Dy -=100.*pix
...
def J1606_K():
    image = py.open('/data/ljo31/Lens/J1606/J1606_med.fits')[0].data.copy()[530:930,780:1150]
    Dx,Dy = 3.,-7.
    OVRS,pix=1,0.6
    Dx -=100.*pix
    Dy -=100.*pix
...
def J1619_K():
    image = py.open('/data/ljo31/Lens/J1619/J1619_nirc2_n_Kp_6x6.fits')[0].data.copy()[100:500,100:500]
    Dx,Dy = 26.,29.
    OVRS,pix=1,0.2
    Dx -=100.*pix
    Dy -=100.*pix
...
def J2228_K():
    image = py.open('/data/ljo31/Lens/J2228/J2228_med.fits')[0].data.copy()[450:830,450:830]
    Dx,Dy = 8.,8.
    OVRS,pix = 1,0.6
    Dx -=100.*pix
    Dy -=100.*pix
